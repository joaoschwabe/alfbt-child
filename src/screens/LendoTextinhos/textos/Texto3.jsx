...
import texto1 from "../images/texto3.png";
...
export default function Texto3() {
    ...
    const atvNome = "lendo textinhos texto 3",
        atvDesc = "No campo do Joaquim";
    ...
    const compartilhar = async () => {
        const [pdf] = await Asset.loadAsync(require("../pdfs/texto3.pdf"));
