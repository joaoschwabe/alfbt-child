...
import texto1 from "../images/texto2.png";
...
export default function Texto2() {
    ...
    const atvNome = "lendo textinhos texto 2",
        atvDesc = "A galinha Malhada";
    ...
    const compartilhar = async () => {
        const [pdf] = await Asset.loadAsync(require("../pdfs/texto2.pdf"));
